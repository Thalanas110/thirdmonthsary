...
export const poems = [
    ...
    {
        "id": 11,
        "title": "Hambal sang Dios: Ikaw kag ang Sinina",
        "author": "Adriaan M. Dimate, BSCS 3-A",
        "content": "Bisan sa puti nga bestida nga mahumok,\nUkon uniporme nga may tig-a nga botones,\nAng imo katahum indi mabutangan sang takod\nSa bisan ano nga panaptan nga imo ginasul-ot.\n\nSa puti nga panaptan nga daw ulap sa kalangitan,\nAng imo pagtindog daw anghel nga nagkanaog,\nSa uniporme nga may serbisyo nga kahulugan,\nIkaw ang makina nga nagapadali sang akon tagiposoon.\n\nAng imo mga mata nagabanaag sing kapawa\nBisan sa pinakadulum nga kagab-ihon,\nAng imo ngisi nagasilak sing gugma\nSa bisan diin nga lugar imo matung-an.\n\nKon magtiniil ka sa altar nga maputi ang bestida,\nUkon magdali-dali sa klase nga may uniporme,\nAng akon kalipay pareho gid gihapon,\nKay ikaw permi ang akon makita sa tunga sang tanan.\n\nAng imo pagkatawo mas labaw pa sa panaptan,\nMas matahum pa sa bisan ano nga disenyo,\nSa puti man ukon sa berde nga uniporme,\nIkaw gid ang pinakamatahum nga obra sang Dios.",
        "preview": "Bisan sa puti nga bestida nga mahumok, Ukon uniporme nga may tig-a nga botones...",
        "tags": ["beauty", "uniform", "wedding dress", "Ilonggo", "admiration"]
    },
    {
        "id": 12,
        "title": "Ang Aton Thesis: Kalipay kag Kamingaw",
        "author": "Adriaan M. Dimate, BSCS 3-A",
        "content": "Sa lawig nga gab-i nga puno sang kape,\nSa lantawan nga mga kodigo nga daw suba,\nIkaw ang akon kaupod sa pagpangita sang solusyon,\nSa kada error nga daw bato sa dalan.\n\nAng imo mga kamot nga nagapangiskriba,\nAng imo hunahuna nga daw super computer,\nNagabulig sa akon nga makita ang dalan,\nPaagi sa kakomplikado nga algoritmo sang kabuhi.\n\nKon ang deadline daw uyan nga nagapadulong,\nIkaw ang payong nga nagaprotehir sa akon,\nKon ang mga datos daw labirinto nga mabudlay,\nIkaw ang suga nga nagatuytoy sa akon.\n\nSa pagtipon-tipon sang mga pahina,\nSa paghimo sang bibliography nga wala katapusan,\nAng imo pagbatyag nagapabaskog sa akon,\nBisan sa pinakamabudlay nga mga oras.\n\nAng aton mga mata nagatagpo sa monitor,\nAng aton mga kamot nagahampang sa teklado,\nAng aton mga hunahuna nagauyog sa isa ka ritmo,\nSa pagtuga sang obra nga magapabilin sa kaharian sang tiempo.\n\nSa katapusan sang makapoy nga dalan,\nKon ang presentasyon mahuman na,\nAng pinakadaku nga premyo indi ang grado,\nKundi ang pag-upod sa imo sa sini nga pagbiyahe.",
        "preview": "Sa lawig nga gab-i nga puno sang kape, Sa lantawan nga mga kodigo nga daw suba...",
        "tags": ["thesis", "academic", "struggle", "Ilonggo", "partnership"]
    },
    {
        "id": 13,
        "title": "Regalo sang Langit",
        "author": "Adriaan M. Dimate, BSCS 3-A",
        "content": "Sa akon pagpangamuyo sa tunga sang kagab-ihon,\nGintugyan ko sa Dios ang akon manggad,\nWala ako magapaabot nga ang Iya sabat,\nIkaw gali ang pinakamatahum nga regalo nga Iya ginhatag.\n\nKon magtan-aw ako sa imo mata nga daw bituon,\nNakita ko ang kamot sang Manunuga nga mahigugmaon,\nKon pamatian ko ang imo tingog nga daw huni sang tumandok,\nNabatian ko ang ambahanon sang mga anghel sa langit.\n\nSa kada adlaw nga mag-abiabi kita,\nSa kada tiyempo nga maghampang kita,\nNakilala ko gid ang gugma sang Ginoo,\nPaagi sa imo nga Iya ginpadala sa akon.\n\nAng imo pagka-mainabyanon, ang imo pagka-makaluluy-on,\nAng imo pagka-matinumanon sa mga kasuguan,\nNagapahanumdom sa akon pirme,\nNga ikaw gid ang pinili sang Dios para sa akon.\n\nIndi ako makapati nga ang kalibutan may ara sini nga bahandi,\nKag gintugyan ini sa akon nga alagaron kag amligan,\nSa imo higot sang gugma, nagapati ako nga,\nAng Dios mismo ang nagdesinyo sang aton pagkakilala.",
        "preview": "Sa akon pagpangamuyo sa tunga sang kagab-ihon, Gintugyan ko sa Dios ang akon manggad...",
        "tags": ["divine gift", "gratitude", "faith", "Ilonggo", "destiny"]
    },
    {
        "id": 14,
        "title": "Tulo ka Tiil sa Pagtuo",
        "author": "Adriaan M. Dimate, BSCS 3-A",
        "content": "Sa simbahan nga puno sang kahayag,\nAng aton mga kamot nagahugpong sa pagpangamuyo,\nIndi lang ikaw kag ako ang nagasimba,\nKundi ang Ginoo mismo ang nagaupod sa aton.\n\nSa kada bentana nga aton ginabuksan,\nSa kada hulagway nga aton ginatukod,\nAng Trinidad nagaluntad sa tunga naton,\nAng Amay, Anak, kag Espiritu nga nagahugpong.\n\nKon magdulog kita sa altar nga puno sang kalooy,\nAng aton mga pagsalig nagadugang kada adlaw,\nAng aton paghigugmaanay indi lang tawhanon,\nKundi may balatyagon man gikan sa langitnon.\n\nSa pagbasa naton sang Pulong nga Balaan,\nSa pag-amba naton sang mga dayawon,\nAng aton duha ka tingog nagaisa sa korus,\nKag ang Espiritu nagatuga sang harmoniya sa tunga naton.\n\nSa mga pagtilaw kag mga pagpamatok,\nAng aton pagtuo daw baroto nga nagalutaw,\nNga bisan sa pinakamakusog nga balod,\nIndi malunod kay ang Dios ang nagagapos sa aton.\n\nSa pagtindog naton subong mag-asawa sa ulihi,\nAng aton pamilya magatukod sa pundasyon sang pagtuo,\nDiin ang Dios pirme ang una nga ginatawag,\nSa tanan nga mga desisyon nga aton himuon.",
        "preview": "Sa simbahan nga puno sang kahayag, Ang aton mga kamot nagahugpong sa pagpangamuyo...",
        "tags": ["faith", "worship", "trinity", "Ilonggo", "spiritual love"]
    },
    {
        "id": 15,
        "title": "Ang Dalan Pakadto sa Balay",
        "author": "Adriaan M. Dimate, BSCS 3-A",
        "content": "Sa akon hunahuna pirme nagalantaw,\nAng adlaw nga dalhon tika sa balay sang akon ginikanan,\nDiin ang mga haligi puno sang handumanan,\nKag ang hagdan may yara sang akon kabataan.\n\nGinapangandaman ko gid ang takna nga,\nMakilala ka sang akon iloy kag amay,\nNga magsiling sila nga \"Amo gid ini siya\",\nAng babayi nga nagpuno sang kahulugan sa kabuhi sang ila anak.\n\nMakita ko ang imo mga mata nga nagakislap,\nSa pagtunton sang mga retrato sang akon pagkabata,\nAng imo ngisi nga daw adlaw sa tunga sang dagom,\nKon mabatian mo ang mga istorya nga makalingaw.\n\nAng akon amay magahatag sa imo sang iya kamot,\nNga daw nagasiling \"Salamat sa pag-amba sang akon anak\",\nAng akon iloy magaguwa sang pinakamaayo nga plato,\nNga ginluto sang gugma kag pagbatyag.\n\nSa kumon nga hagdan sang akon balay,\nAng aton mga tiil magatapak sa pareho nga dughan,\nDiin ang akon pagkatawo nagtikang,\nKag diin man magasugod ang aton kaugalingon nga panimalay.\n\nIni nga pagpasakop indi lang pagkilala,\nKundi pag-ako man nga ikaw gid ang pinili,\nAng bunga sang akon tagiposoon nga ginapakita,\nSa mga tawo nga pinakamahal sa akon kabuhi.",
        "preview": "Sa akon hunahuna pirme nagalantaw, Ang adlaw nga dalhon tika sa balay sang akon ginikanan...",
        "tags": ["family", "parents", "tradition", "Ilonggo", "commitment"]
    },
    {
        "id": 16,
